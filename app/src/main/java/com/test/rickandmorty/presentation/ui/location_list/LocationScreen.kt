...
import com.test.rickandmorty.presentation.components.LocationCard
...
fun LocationScreen(
    ...
    val locationsLastIndex = viewModel.locationsLastIndex.value

    val lazyListState = rememberLazyListState()

    lazyListState.firstVisibleItemIndex.let {
        if (!loading && it > locationsLastIndex) {
            viewModel.onTriggerEvent(LocationsEvent.NextPage)
        }
    }
